...
(function (factory) {
    ...
    $.widget('blueimpUI.fileupload', parentWidget, {
        ...
        options: {
            ...
            uploadTemplateId: 'alliant-template-upload',
            // The ID of the download template:
            downloadTemplateId: 'alliant-template-download',
        ...
        _startHandler: function (e) {
            e.preventDefault();
            var button = $(this),
                template = button.closest('.alliant-template-upload'),
        ...
        _cancelHandler: function (e) {
            e.preventDefault();
            var template = $(this).closest('.alliant-template-upload'),
                data = template.data('data') || {};
            if (!data.jqXHR) {
        ...
        _deleteHandler: function (e) {
            ...
            e.data.fileupload._trigger('destroy', e, {
                context: button.closest('.alliant-template-download'),
        ...
        _destroyEventHandlers: function () {
            ...
            options.filesContainer
                ...
                .undelegate('.jsAlliantFileCancel', 'click.' + options.namespace)
                .undelegate('.jsAlliantFileDelete', 'click.' + options.namespace);
